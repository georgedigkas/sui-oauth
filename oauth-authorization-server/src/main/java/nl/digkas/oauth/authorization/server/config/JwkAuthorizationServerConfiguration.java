package nl.digkas.oauth.authorization.server.config;
...
public class JwkAuthorizationServerConfiguration {
    ...
    private static final String KEY_STORE_FILE = "sui-jwt.jks";
    private static final String KEY_STORE_PASSWORD = "sui-pass";
    private static final String KEY_ALIAS = "sui-oauth-jwt";
    private static final String JWK_KID = "sui-key-id";
